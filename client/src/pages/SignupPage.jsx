...
const SignupPage = () => {
  ...
  return (
    <div className='flex w-full h-[100vh]'>
      ...
      {/* RIGHT */}
      <div className='flex w-full md:w-3/3 h-full bg-white dark:bg-gradient-to-b md:dark:bg-gradient-to-r from-black via-[#071b3e] to-black items-center px-4 md:px-20 lg:px-40'>
