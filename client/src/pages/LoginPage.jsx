...
import { emailSignIn } from "../utils/apiCalls";
...
const LoginPage = () => {
  ...
  return (
    <div className="flex w-full  h-[100vh]">
      ...
      <div className="flex w-full md:w-3/3 md:justify-center h-full bg-white dark:bg-gradient-to-b md:dark:bg-gradient-to-r from-black via-[#710d62] to-black items-center px-10 md:px-20 lg:px-40">
